    ...
    <div class="verification-container">
        <div class="verification-card">
            ...
            <div class="verification-header">
                ...
                <h1 class="verification-title">IMF CODE VERIFICATION</h1>
                <p class="verification-subtitle">Please enter the IMF code to complete your transfer</p>
            </div>
            
            <div class="verification-body">
                <div class="verification-message">
                    Hello, <strong><?= $fullName?></strong>! Please enter your IMF code to complete your transfer.
                </div>
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="imf-code">Enter IMF Code</label>
                        <input type="number" id="imf-code" name="imf_code" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        ...
                        <button type="submit" class="btn btn-primary" name="imf_submit">Verify IMF Transfer</button>
                    </div>
                </form>
            </div>
            <?php
            ...
            <div class="verification-body">
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="imf-code-dom">Enter OTP Code</label>
                        <input type="number" id="imf-code-dom" name="imf_code" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        <button type="button" class="btn btn-outline" onclick="window.history.back()">Cancel</button>
                        <button type="submit" class="btn btn-primary" name="submit-dom">Submit</button>
                    </div>
                </form>
            </div>
            <?php
