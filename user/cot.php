    ...
    <div class="verification-container">
        <div class="verification-card">
            ...
            <div class="verification-header">
                ...
                <h1 class="verification-title">COT CODE VERIFICATION</h1>
                <p class="verification-subtitle">Please enter the COT code to facilitate the transfer of your funds</p>
            </div>
            
            <div class="verification-body">
                <div class="verification-message">
                    Hello, <strong><?= $fullName?></strong>! Please enter your COT code to facilitate the transfer of your funds.
                </div>
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="cot-code">Enter COT Code</label>
                        <input type="number" id="cot-code" name="cot_code" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        ...
                        <button type="submit" class="btn btn-primary" name="cot_submit">Continue Transfer</button>
                    </div>
                </form>
            </div>
            <?php
            ...
            <div class="verification-header">
                ...
                <h1 class="verification-title">Verify Transaction Pin</h1>
            ...
            <div class="verification-body">
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="acct-cot">Enter OTP Code</label>
                        <input type="number" id="acct-cot" name="acct_cot" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        <button type="button" class="btn btn-outline" onclick="window.history.back()">Cancel</button>
                        <button type="submit" class="btn btn-primary" name="cot_submit">Submit</button>
                    </div>
                </form>
            </div>
            <?php
