    ...
    <div class="verification-container">
        <div class="verification-card">
            ...
            <div class="verification-header">
                ...
                <h1 class="verification-title">TAX CODE VERIFICATION</h1>
                <p class="verification-subtitle">Please enter the TAX code to facilitate the transfer of your funds</p>
            </div>
            
            <div class="verification-body">
                <div class="verification-message">
                    Hello, <strong><?= $fullName?></strong>! Please enter your TAX code to facilitate the transfer of your funds.
                </div>
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="tax-code">Enter TAX Code</label>
                        <input type="number" id="tax-code" name="tax_code" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        ...
                        <button type="submit" class="btn btn-primary" name="tax_submit" onclick="this.classList.toggle('button--loading')">
            ...
            <div class="verification-header">
                ...
                <h1 class="verification-title">Verify Transfer Token</h1>
                <p class="verification-subtitle">Please enter the 6 digit OTP sent to your phone or email</p>
            </div>
            
            <div class="verification-body">
                <div class="verification-message">
                    Hello, <strong><?= ucwords($fullName)?></strong>! Please enter the 6 digit OTP sent to your <strong><?= $row['acct_phone']?></strong> or <strong><?= $row['acct_email']?></strong>
                </div>
                ...
                <form class="verification-form" action="" method="post">
                    <div class="input-group">
                        <label for="acct-tax">Enter OTP Code</label>
                        <input type="number" id="acct-tax" name="acct_tax" placeholder="• • • • • •" maxlength="6" autocomplete="off" required>
                    </div>
                    ...
                    <div class="verification-actions">
                        <button type="button" class="btn btn-outline" onclick="window.history.back()">Cancel</button>
                        <button type="submit" class="btn btn-primary" name="submit-dom" onclick="this.classList.toggle('button--loading')">
                            <span class="button__text">Continue Transfer</span>
                        </button>
                    </div>
                </form>
