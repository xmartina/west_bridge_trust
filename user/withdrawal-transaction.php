...
<?php
$pageName = "Withdrawal Transaction";
...
<div class="main-content">
    ...
    <div class="dashboard-content">
        <div class="transactions-header">
            <div class="transactions-title">Your Withdrawal History</div>
                ...
                <tbody>
                    ...
                    if($stmt->rowCount() > 0) {
                        while ($withdrawal = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            $wire_status = wireStatus($withdrawal['status']);
                            ?>
                            <tr>
                                <td><?= $sn++ ?></td>
                                <td><strong><?= $withdrawal['reference_id'] ?></strong></td>
                                <td class="amount-negative">-<?= $currency . number_format($withdrawal['amount'], 2) ?></td>
                                <td><?= ucfirst($withdrawal['method'] ?? 'Bank Transfer') ?></td>
                                <td><?= $wire_status ?></td>
                                <td><?= date('M d, Y', strtotime($withdrawal['createdAt'])) ?></td>
                        ...
                        <tr>
                            <td colspan="7" class="no-transactions">
                                ...
                                <div style="font-size: 18px; font-weight: 600; margin-bottom: 10px;">No Withdrawal Transactions</div>
                                <div>You haven't made any withdrawals yet. When you do, they'll appear here.</div>
                            </td>
                        </tr>
                        <?php
                    }
